...
resource "aws_iam_role_policy_attachment" "codebuild_lambda_role" {
  role = aws_iam_role.codebuild_role.name
  policy_arn = "arn:aws:iam::aws:policy/AWSLambda_FullAccess" // this policy should be changed to a new policy.
}
